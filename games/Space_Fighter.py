...
class Game:
    ...
    def draw_boss(self, surface):
        ...
        if self.boss:
            ...
            if self.stage == 3:
                draw_text(surface, "3스테이지 보스는 몸체만 공격 가능", FONT_22, YELLOW, WIDTH // 2, y + 66, center=True)
    ...
    def draw_game_over(self, surface):
        ...
        draw_text(surface, "R 키를 눌러 다시 시작", FONT_36, WHITE, WIDTH // 2, HEIGHT // 2 + 40, center=True)

    def draw_clear(self, surface):
        draw_text(surface, "STAGE CLEAR", FONT_72, GREEN, WIDTH // 2, HEIGHT // 2 - 60, center=True)
        draw_text(surface, "최종 스테이지를 클리어했습니다", FONT_36, WHITE, WIDTH // 2, HEIGHT // 2 + 10, center=True)
